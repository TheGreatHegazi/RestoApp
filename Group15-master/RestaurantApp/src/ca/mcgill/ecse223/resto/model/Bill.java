...
public class Bill implements Serializable
{
  ...
  public boolean setLoyaltyCard(LoyaltyCard aLoyaltyCard)
  {
    boolean wasSet = false;
    LoyaltyCard existingLoyaltyCard = loyaltyCard;
    loyaltyCard = aLoyaltyCard;
    if (existingLoyaltyCard != null && !existingLoyaltyCard.equals(aLoyaltyCard))
    {
      existingLoyaltyCard.removeBill(this);
    }
    if (aLoyaltyCard != null)
    {
      aLoyaltyCard.addBill(this);
    }
    wasSet = true;
    return wasSet;
  }
  ...
  public void delete()
  {
    ...
    if (loyaltyCard != null)
    {
      LoyaltyCard placeholderLoyaltyCard = loyaltyCard;
      this.loyaltyCard = null;
      placeholderLoyaltyCard.removeBill(this);
    }
  }

...
public class RestoApp implements Serializable
{
  ...
  /* Code from template association_AddManyToOne */
  public LoyaltyCard addLoyaltyCard(String aName, String aEmail, String aPhoneNumber)
  {
    return new LoyaltyCard(aName, aEmail, aPhoneNumber, this);
  }
  ...
  // line 10 "../../../../../RestoAppPersistence.ump"
   public void reinitialize(){
    if(loyaltyCards==null){
		...
		LoyaltyCard.reinitializeAutouniqueNumber(this.getLoyaltyCards());
		LoyaltyCard.reinitializeUniqueName(this.getLoyaltyCards());
  }
